...
import 'package:erp_mobile/features/hr/domain/entities/attendance_entry.dart';
import 'package:erp_mobile/features/hr/domain/usecases/toggle_clock.dart';
import 'package:test/test.dart';

void main() {
  group('resolveClockAction', () {
    String idGen() => 'gen-id';
