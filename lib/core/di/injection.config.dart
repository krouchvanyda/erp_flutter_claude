...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i1072.CachedUserDao>(
      () => appModule.cachedUserDao(gh<_i460.SharedPreferences>()),
    );
    gh.lazySingleton<_i18.BiometricSettingsDao>(
      () => appModule.biometricSettingsDao(gh<_i460.SharedPreferences>()),
    );
    gh.lazySingleton<_i617.NotificationsDao>(
      () => appModule.notificationsDao(gh<_i460.SharedPreferences>()),
    );
