...
import 'package:erp_mobile/features/finance/data/repositories/drift_invoices_repository.dart';
...
void main() {
  ...
  late DriftInvoicesRepository repo;

  setUp(() {
    db = AppDatabase(NativeDatabase.memory());
    dao = db.invoicesDao;
    syncQueue = db.syncQueueDao;
    repo = DriftInvoicesRepository(dao: dao, syncQueue: syncQueue);
  });
