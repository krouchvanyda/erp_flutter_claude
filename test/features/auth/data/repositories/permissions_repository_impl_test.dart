...
import 'package:erp_mobile/features/auth/data/repositories/permissions_repository_impl.dart';
...
void main() {
  ...
  setUp(() async {
    ...
    repo = PermissionsRepositoryImpl(cachedUserDao: db.cachedUserDao);
