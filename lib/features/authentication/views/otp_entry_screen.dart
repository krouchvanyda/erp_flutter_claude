...
import 'package:erp_mobile/features/authentication/view_models/otp_view_model.dart';
import 'package:erp_mobile/features/authentication/view_models/otp_event.dart';
import 'package:erp_mobile/features/authentication/view_models/otp_state.dart';
import 'package:erp_mobile/features/authentication/views/widgets/otp_input_field.dart';
...
class OtpEntryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<OtpViewModel>(
      create: (_) => OtpViewModel(otpRepository: AppDependencies.I.otpRepository),
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<OtpViewModel, OtpState>(
      ...
      listener: (context, state) async {
        ...
        if (context.mounted) {
          // OtpEntryScreen is pushed onto the root Navigator from
          // LoginScreen via ConfigRouter, so go_router's location is
