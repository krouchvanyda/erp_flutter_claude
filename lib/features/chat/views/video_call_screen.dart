...
///
/// Same shape as [VoiceCallScreen] — page mounts, kicks off either an
...
class VideoCallScreen extends StatefulWidget {
  ...
  /// Tracks whether a VideoCallScreen is currently mounted. Used by
  ...
  @override
  State<VideoCallScreen> createState() => _VideoCallPageState();
}

class _VideoCallPageState extends State<VideoCallScreen>
  ...
  void initState() {
    super.initState();
    VideoCallScreen.isMounted = true;
  ...
  @override
  void dispose() {
    VideoCallScreen.isMounted = false;
    _hideTimer?.cancel();
    _ticker?.cancel();
