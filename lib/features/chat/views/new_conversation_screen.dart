...
import 'package:erp_mobile/data/services/chat_dto_mappers.dart';
...
class NewConversationScreen extends StatefulWidget {
  ...
  @override
  State<NewConversationScreen> createState() => _NewConversationPageState();
}

enum _Mode { direct, group }

class _NewConversationPageState extends State<NewConversationScreen> {
  ...
  Future<void> _create() async {
    ...
    try {
      ...
      await ConfigRouter.pushPageAnimation(
        context,
        ChatConversationScreen(conversationId: created.id),
      );
    } catch (e) {
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
