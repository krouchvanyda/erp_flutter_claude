...
import 'package:erp_mobile/features/settings/models/assign_roles_request.dart';
import 'package:erp_mobile/features/settings/models/page_response.dart';
import 'package:erp_mobile/features/settings/models/role_dto.dart';
import 'package:erp_mobile/features/settings/models/user_dto.dart';
...
class AssignmentsScreen extends StatefulWidget {
  ...
  @override
  State<AssignmentsScreen> createState() => _AssignmentsPageState();
}

class _AssignmentsPageState extends State<AssignmentsScreen> {
  final _users = AppDependencies.I.usersRemoteDataSource;
  final _roles = AppDependencies.I.rolesRemoteDataSource;
