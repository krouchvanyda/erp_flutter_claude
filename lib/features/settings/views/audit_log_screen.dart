...
class AuditLogScreen extends StatefulWidget {
  ...
  @override
  State<AuditLogScreen> createState() => _AuditLogPageState();
}

class _AuditLogPageState extends State<AuditLogScreen> {
  final Set<AuditAction> _actionFilter = {};
  String _searchQuery = '';

  @override
  Widget build(BuildContext context) {
    final repo = AppDependencies.I.auditLogRepository;
