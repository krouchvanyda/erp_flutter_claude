...
void main() {
  ...
  late ApproveInvoiceUseCase usecase;
  ...
  group('ApproveInvoiceUseCase', () {
    ...
    test('notFound when the id is unknown', () async {
      ...
      await expectLater(
        usecase(invoiceId: 'missing', approverId: 'u'),
    ...
    test('happy path — calls repo.approve with the injected clock', () async {
      ...
      final result = await usecase(invoiceId: 'inv-1', approverId: 'u-42');
