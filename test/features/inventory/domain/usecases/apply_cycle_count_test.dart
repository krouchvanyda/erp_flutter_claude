...
import 'package:erp_mobile/features/inventory/domain/entities/cycle_count.dart';
...
import 'package:erp_mobile/features/inventory/domain/usecases/apply_cycle_count.dart';
...
void main() {
  ...
  test('posts one adjustment per non-zero-variance line', () async {
    ...
    final out = await usecase(_count(lines: const [
