...
import 'package:erp_mobile/features/notifications/view_models/notification_inbox_view_model.dart';
import 'package:erp_mobile/features/notifications/view_models/notification_inbox_event.dart';
import 'package:erp_mobile/features/notifications/view_models/notification_inbox_state.dart';
import 'package:erp_mobile/features/notifications/views/notification_category_icon.dart';
...
class NotificationInboxScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<NotificationInboxViewModel>(
      create: (_) => NotificationInboxViewModel(repository: AppDependencies.I.notificationsRepository)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: DynamicAppBar(
        ...
        actions: [
          BlocBuilder<NotificationInboxViewModel, NotificationInboxState>(
            buildWhen: (a, b) =>
            ...
            builder: (context, state) {
              ...
              return IconButton(
                ...
                onPressed: () => context.read<NotificationInboxViewModel>().add(
      ...
      body: DynamicStatusBar(
        child: BlocBuilder<NotificationInboxViewModel, NotificationInboxState>(
...
class _NotificationTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final l10n = AppLocalizations.of(context);
    final bloc = context.read<NotificationInboxViewModel>();
