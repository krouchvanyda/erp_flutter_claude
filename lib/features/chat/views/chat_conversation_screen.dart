...
import 'package:erp_mobile/features/chat/views/widgets/chat_avatar.dart';
import 'package:erp_mobile/features/chat/views/widgets/chat_bubble.dart';
import 'package:erp_mobile/features/chat/views/widgets/typing_indicator.dart';
import 'package:erp_mobile/features/chat/views/chat_info_screen.dart';
import 'package:erp_mobile/features/chat/views/image_viewer_screen.dart';
import 'package:erp_mobile/features/chat/views/video_call_screen.dart';
import 'package:erp_mobile/features/chat/views/voice_call_screen.dart';
...
class ChatConversationScreen extends StatefulWidget {
  ...
  @override
  State<ChatConversationScreen> createState() => _ChatConversationPageState();
}

class _ChatConversationPageState extends State<ChatConversationScreen> {
  ...
  void initState() {
    super.initState();
    _convRepo = AppDependencies.I.conversationsRepository;
    _msgRepo = AppDependencies.I.messagesRepository;
    _settings = AppDependencies.I.chatSettings;
    ...
    unawaited(AppDependencies.I.conversationsRepository
  ...
  void dispose() {
    ...
    AppDependencies.I.chatTransport.unsubscribeConversation(widget.conversationId);
    _settingsSub?.cancel();
    _messagesSub?.cancel();
                      ...
                      child: StreamBuilder<List<ChatMessage>>(
                        ...
                        builder: (context, msgSnap) {
                          ...
                          return StreamBuilder<List<ChatCallLog>>(
                            stream: AppDependencies.I.callLogRepository
                                .watchAll(),
    ...
    return AppBar(
        ...
        builder: (context, snap) {
          ...
          return InkWell(
            ...
            onTap: () => ConfigRouter.pushPageAnimation(
              context,
              ChatInfoScreen(conversationId: conv.id),
            ),
            child: Padding(
                  ...
                  Flexible(
                    child: Column(
                      ...
                      children: [
                        ...
                        AnimatedBuilder(
                          animation:
                              AppDependencies.I.presenceRepository.revision,
      ...
      actions: [
        ...
        IconButton(
          ...
          onPressed: () => ConfigRouter.pushPageAnimation(
            context,
            ChatInfoScreen(conversationId: widget.conversationId),
          ),
        ),
      ],
    );
  ...
  void _openImageViewer(ChatMessage m) {
    ConfigRouter.pushPageAnimation(context, ImageViewerScreen(message: m));
  }
...
class _PinnedBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ChatMessage?>(
      future: AppDependencies.I.messagesRepository.findById(messageId),
      builder: (context, snap) {
