...
class MessageSearchScreen extends StatefulWidget {
  ...
  @override
  State<MessageSearchScreen> createState() => _MessageSearchPageState();
}

class _MessageSearchPageState extends State<MessageSearchScreen> {
      ...
      child: InkWell(
        ...
        onTap: () async {
          ...
          await ConfigRouter.pushPageAnimation(
            context,
            ChatConversationScreen(conversationId: message.conversationId),
          );
        },
        child: Container(
