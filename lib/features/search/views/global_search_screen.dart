...
import 'package:erp_mobile/core/shortcuts/module_shortcut_catalog.dart';
...
import 'package:erp_mobile/data/services/module_shortcut_search_provider.dart';
import 'package:erp_mobile/features/search/models/search_result_model.dart';
import 'package:erp_mobile/data/services/federated_search.dart';
import 'package:erp_mobile/features/search/view_models/global_search_view_model.dart';
import 'package:erp_mobile/features/search/view_models/global_search_event.dart';
import 'package:erp_mobile/features/search/view_models/global_search_state.dart';

class GlobalSearchScreen extends StatefulWidget {
  const GlobalSearchScreen({super.key});

  @override
  State<GlobalSearchScreen> createState() => _GlobalSearchPageState();
}

class _GlobalSearchPageState extends State<GlobalSearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final permissions = AppDependencies.I.permissionsSnapshot;
    final theme = Theme.of(context);

    return BlocProvider<GlobalSearchViewModel>(
      ...
      child: BlocBuilder<GlobalSearchViewModel, GlobalSearchState>(
        builder: (context, state) {
          final bloc = context.read<GlobalSearchViewModel>();
