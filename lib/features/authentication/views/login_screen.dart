...
import 'package:erp_mobile/features/authentication/view_models/login_view_model.dart';
...
import 'package:erp_mobile/features/authentication/views/register_screen.dart';

class LoginScreen extends StatefulWidget {
  const LoginScreen({super.key, this.onSimulatedLogin});
...
class _LoginPageState extends State<LoginScreen> {
  ...
  /// Validate the form, then hand the credentials to the ViewModel.
  /// Success/failure side-effects are handled in [_onLoginState].
  ...
  /// React to ViewModel state transitions: complete the redirect on
  /// success, surface the typed failure as a snackbar otherwise.
    ...
    switch (state.status) {
      ...
      case LoginStatus.failure:
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(_failureMessage(failure, AppLocalizations.of(context))),
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => LoginViewModel(AppDependencies.I.authRepository),
                  ...
                  child: ConstrainedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: TextButton(
                                        onPressed: () => ConfigRouter.pushPageAnimation(context, const ForgotPasswordScreen()),
                                    ...
                                    BlocBuilder<LoginViewModel, LoginState>(
                                      ...
                                      builder: (context, state) => SizedBox(
                                        height: 54,
                                        child: FilledButton(
                                          // Disables while the in-flight
                                          // request runs (LoadingScreen
                                          // overlay shows) — one source of
                                          // "we're working", no competing
                                          // spinners.
                                    ...
                                    SizedBox(
                                      ...
                                      child: OutlinedButton.icon(
                                        onPressed: () => ConfigRouter.pushPageAnimation(context, const BiometricUnlockScreen()),
                          ...
                          children: [
                            ...
                            TextButton(
                              onPressed: () => ConfigRouter.pushPageAnimation(
                                context,
                                RegisterScreen(onSimulatedRegister: widget.onSimulatedLogin),
                              ),
                        ...
                        // Demo Link
                        // TextButton(
                        //   onPressed: () => ConfigRouter.pushPageAnimation(context, const OtpEntryScreen()),
