...
import 'package:erp_mobile/features/inventory/data/repositories/drift_items_repository.dart';
import 'package:erp_mobile/features/inventory/data/repositories/drift_stock_movements_repository.dart';
...
void main() {
  ...
  late DriftItemsRepository itemsRepo;
  late DriftStockMovementsRepository movementsRepo;

  setUp(() {
    db = AppDatabase(NativeDatabase.memory());
    dao = db.itemsDao;
    syncQueue = db.syncQueueDao;
    itemsRepo = DriftItemsRepository(dao: dao, syncQueue: syncQueue);
    movementsRepo =
        DriftStockMovementsRepository(dao: dao, syncQueue: syncQueue);
  });
  ...
  group('Slice 5.3.1 — lazy seed', () {
    ...
    test('pre-populated table skips seeding entirely', () async {
