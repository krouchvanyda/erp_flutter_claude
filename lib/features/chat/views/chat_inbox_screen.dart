...
import 'package:erp_mobile/features/chat/views/chat_conversation_screen.dart';
import 'package:erp_mobile/features/chat/views/message_search_screen.dart';
import 'package:erp_mobile/features/chat/views/new_conversation_screen.dart';
...
class ChatInboxScreen extends StatefulWidget {
  ...
  @override
  State<ChatInboxScreen> createState() => _ChatInboxPageState();
}

class _ChatInboxPageState extends State<ChatInboxScreen>
    ...
    return Material(
      ...
      child: InkWell(
        ...
        onTap: () => ConfigRouter.pushPageAnimation(
          context,
          isVideo
              ? VideoCallScreen(conversationId: log.conversationId)
              : VoiceCallScreen(conversationId: log.conversationId),
        ),
        child: Container(
          padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
          decoration: BoxDecoration(
