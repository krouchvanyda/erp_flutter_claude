...
import 'package:erp_mobile/shared/widgets/avatar_picker_sheet.dart';
...
import 'package:erp_mobile/features/chat/views/message_search_screen.dart';
        ...
        children: [
          _ActionRow(
            ...
            onTap: () => ConfigRouter.pushPageAnimation(
              context,
              VoiceCallScreen(conversationId: conversation.id),
            ),
          ),
          const _Hairline(),
          _ActionRow(
            ...
            onTap: () => ConfigRouter.pushPageAnimation(
              context,
              VideoCallScreen(conversationId: conversation.id),
            ),
          ),
          const _Hairline(),
          _ActionRow(
            ...
            onTap: () => ConfigRouter.pushPageAnimation(
              context,
              MessageSearchScreen(conversationId: conversation.id),
            ),
          ),
          if (conversation.isGroup) ...[
            const _Hairline(),
        ...
        child: InkWell(
          ...
          onTap: isImage
              ? () => ConfigRouter.pushPageAnimation(
                    context,
                    ImageViewerScreen(message: message),
                  )
    ...
    return InkWell(
      onTap: () => ConfigRouter.pushPageAnimation(
        ...
        isVideo
            ...
            : VoiceCallScreen(conversationId: conversationId),
      ),
      child: Padding(
