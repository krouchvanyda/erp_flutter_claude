...
class ApiConfigScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final repo = AppDependencies.I.apiEnvironmentsRepository;
            ...
            children: [
              ...
              SizedBox(
                ...
                child: FilledButton(
                  onPressed: () async {
                    try {
                      await AppDependencies.I.apiEnvironmentsRepository.createFromInput(
                        name: nameCtrl.text,
...
class _EnvTile extends StatelessWidget {
  ...
  Future<void> _deleteEnv(BuildContext context) async {
    ...
    final l10n = AppLocalizations.of(context);
    try {
      await AppDependencies.I.apiEnvironmentsRepository.deleteGuarded(
        env: env,
