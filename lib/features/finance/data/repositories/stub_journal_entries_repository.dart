...
/// In-memory journal entries (Slice 3.3.1). Each entry mirrors a
/// finance event from the seed transactions so the GL view tells the
/// same story as the chart of accounts.
class StubJournalEntriesRepository implements JournalEntriesRepository {
